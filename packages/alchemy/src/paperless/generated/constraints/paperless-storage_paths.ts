/**
 * Generated Paperless-ngx REST API (OpenAPI 3.0.3) request-body constraints for `/api/storage_paths/` — DO NOT EDIT BY HAND.
 *
...
export const PAPERLESS_STORAGE_PATHS_CONSTRAINTS: Readonly<Record<string, EndpointConstraints>> = {
  "paperless:PATCH /api/storage_paths/{id}/": {
  ...
  "paperless:POST /api/storage_paths/": {
    ...
    "path": {"minLength":1,"required":true,"type":"string"},
  },
};
