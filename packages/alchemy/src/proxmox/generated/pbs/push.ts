/**
 * Generated proxmox-backup-server API types for `/push` — DO NOT EDIT BY HAND.
 *
...
/** POST /push — form/query parameters (path segments omitted). */
...
/** POST /push — `data` payload after client unwrap. */
export type PushPostReturn = null;
