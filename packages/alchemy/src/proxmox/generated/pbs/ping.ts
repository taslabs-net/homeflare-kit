/**
 * Generated proxmox-backup-server API types for `/ping` — DO NOT EDIT BY HAND.
 *
...
/** GET /ping — `data` payload after client unwrap. */
export type PingGetReturn = { pong: boolean | 0 | 1 };
