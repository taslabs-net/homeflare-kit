 ...
 *   README exactly as PR 222 declared it. `/discord` (2026-09-24, new family, not a
 *   migration) imports `@distilled.cloud/discord` the same plain-peer way.
 *   ⛔ None of them failed at INSTALL. All six threw at import, which is why a test that
...
console.log('all seventeen subpaths import and resolve');
`,
  );
