...
- [#213](https://github.com/taslabs-net/homeflare-kit/pull/213) [`8846fee`](https://github.com/taslabs-net/homeflare-kit/commit/8846feedb520c6eae2c9ae87ae82543fc4500750) Thanks [@taslabs-net](https://github.com/taslabs-net)! - `repo-shape` now clears a rendered file after `render.ts` stops emitting it, instead of
...
- [#199](https://github.com/taslabs-net/homeflare-kit/pull/199) [`d8a5898`](https://github.com/taslabs-net/homeflare-kit/commit/d8a5898a4a6c8ffc589c9e22d4f824255140896f) Thanks [@taslabs-net](https://github.com/taslabs-net)! - `repo-shape` no longer renders a `homeflare` Dependabot group or
